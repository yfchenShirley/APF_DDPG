...
class Agent:
    def __init__(self, input_dims, alpha=0.001, beta=0.002, env=None,
                 gamma=0.99, n_actions=2, max_size=10000, tau=0.005,
    ...
    def save_models(self, exp):
        ...
        self.target_actor.save_weights(save_path + self.target_actor.checkpoint_file)
        self.critic.save_weights(save_path + self.critic.checkpoint_file)
        self.target_critic.save_weights(save_path + self.target_critic.checkpoint_file)
    ...
    def load_models(self, exp):
        ...
        self.target_actor.load_weights(save_path + self.target_actor.checkpoint_file)
        self.critic.load_weights(save_path + self.critic.checkpoint_file)
        self.target_critic.load_weights(save_path + self.target_critic.checkpoint_file)
